...
// Type cho props của TabLayout (nếu cần mở rộng)
...
const TabLayout: React.FC<TabLayoutProps> = () => {
  ...
  const colorScheme: "light" | "dark" = ctxTheme ?? fallback ?? "light";
  ...
  return (
    <Tabs
      ...
      detachInactiveScreens={false} // Quan trọng: giữ màn hình không hoạt động
