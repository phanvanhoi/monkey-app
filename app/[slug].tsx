      ...
      <View style={[styles.card, { backgroundColor: themeColors.surface }]}>
        ...
        <View style={styles.infoGrid}>
          ...
          <View style={styles.infoCol}>
            ...
            <Text style={styles.value}>{story.statistics?.total_watched}</Text>
            ...
            <Text style={styles.value}>
              {story.status === "processing" ? "Đang phát hành" : story.status}
            </Text>
          </View>
        </View>
...
const styles = StyleSheet.create({
  container: { flex: 1 },
  card: { margin: 16, borderRadius: 12, padding: 16, elevation: 2 },
  cover: { width: "100%", height: 220, borderRadius: 12, marginBottom: 12 },
  title: {
    fontWeight: "bold",
    fontSize: 20,
    marginBottom: 8,
